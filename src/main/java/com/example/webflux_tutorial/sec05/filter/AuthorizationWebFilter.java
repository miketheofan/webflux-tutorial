package com.example.webflux_tutorial.sec05.filter;

import com.example.webflux_tutorial.sec05.enums.Category;
...
public class AuthorizationWebFilter implements WebFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, WebFilterChain chain) {
        ...
        return switch (category) {
            ...
            case ADMIN -> admin(exchange, chain);
        };
    }

    private Mono<Void> admin(ServerWebExchange exchange, WebFilterChain chain) {
