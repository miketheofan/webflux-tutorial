package com.example.webflux_tutorial.sec03.controller;

import com.example.webflux_tutorial.sec03.dto.CustomerDto;
import com.example.webflux_tutorial.sec03.service.CustomerService;
...
public class CustomerController {
    ...
    public Mono<ResponseEntity<CustomerDto>> getCustomer(@PathVariable Integer id) {
        return this.customerService.getCustomerById(id)
                ...
                .defaultIfEmpty(ResponseEntity.status(410).build());
    }
    ...
    public Mono<ResponseEntity<CustomerDto>> updateCustomer(@PathVariable Integer id, @RequestBody Mono<CustomerDto> mono) {
        return this.customerService.updateCustomer(id, mono)
                .map(ResponseEntity::ok)
                .defaultIfEmpty(ResponseEntity.status(405).build());
    }
